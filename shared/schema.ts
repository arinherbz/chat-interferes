...
import { pgTable, text, varchar, integer, decimal, boolean, timestamp, json, jsonb, uniqueIndex, index } from "drizzle-orm/pg-core";
...
// ===================== USER SESSIONS =====================
// Managed by connect-pg-simple in production, but declared here so drizzle-kit
// does not attempt to drop the existing table during CI schema pushes.
